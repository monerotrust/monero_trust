...
from fake_stake.base_test import MoneroTrust_FakeStakeTest

class zXMTwrappedSerialsTest(MoneroTrust_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zXMTs..." % DENOM_TO_USE)
