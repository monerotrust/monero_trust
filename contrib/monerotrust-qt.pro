...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/monerotrust-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/monerotrust-cli.cpp \
           src/monerotrust-tx.cpp \
           src/monerotrust.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/monerotrust.qrc src/qt/monerotrust_locale.qrc

TRANSLATIONS += src/qt/locale/monerotrust_bg.ts \
                src/qt/locale/monerotrust_de.ts \
                src/qt/locale/monerotrust_en.ts \
                src/qt/locale/monerotrust_es.ts \
                src/qt/locale/monerotrust_fi.ts \
                src/qt/locale/monerotrust_fr.ts \
                src/qt/locale/monerotrust_it.ts \
                src/qt/locale/monerotrust_ja.ts \
                src/qt/locale/monerotrust_pl.ts \
                src/qt/locale/monerotrust_pt.ts \
                src/qt/locale/monerotrust_ru.ts \
                src/qt/locale/monerotrust_sk.ts \
                src/qt/locale/monerotrust_sv.ts \
                src/qt/locale/monerotrust_vi.ts \
                src/qt/locale/monerotrust_zh_CN.ts \
                src/qt/locale/monerotrust_zh_TW.ts
