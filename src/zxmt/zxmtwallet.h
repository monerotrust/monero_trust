...
#ifndef MoneroTrust_ZXMTWALLET_H
#define MoneroTrust_ZXMTWALLET_H
...
public:
    CzXMTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXMT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXMT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //MoneroTrust_ZXMTWALLET_H
