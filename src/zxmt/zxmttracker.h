...
#ifndef MoneroTrust_ZXMTTRACKER_H
#define MoneroTrust_ZXMTTRACKER_H
...
public:
    CzXMTTracker(std::string strWalletFile);
    ~CzXMTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXMTWallet* zXMTWallet = NULL);
...
#endif //MoneroTrust_ZXMTTRACKER_H
