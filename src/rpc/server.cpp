...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MoneroTrust server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MoneroTrust server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MoneroTrust features */
        {"monerotrust", "listmasternodes", &listmasternodes, true, true, false},
        {"monerotrust", "getmasternodecount", &getmasternodecount, true, true, false},
        {"monerotrust", "masternodeconnect", &masternodeconnect, true, true, false},
        {"monerotrust", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"monerotrust", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"monerotrust", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"monerotrust", "masternodecurrent", &masternodecurrent, true, true, false},
        {"monerotrust", "masternodedebug", &masternodedebug, true, true, false},
        {"monerotrust", "startmasternode", &startmasternode, true, true, false},
        {"monerotrust", "createmasternodekey", &createmasternodekey, true, true, false},
        {"monerotrust", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"monerotrust", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"monerotrust", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"monerotrust", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"monerotrust", "getmasternodescores", &getmasternodescores, true, true, false},
        {"monerotrust", "preparebudget", &preparebudget, true, true, false},
        {"monerotrust", "submitbudget", &submitbudget, true, true, false},
        {"monerotrust", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"monerotrust", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"monerotrust", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"monerotrust", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"monerotrust", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"monerotrust", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"monerotrust", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"monerotrust", "checkbudgets", &checkbudgets, true, true, false},
        {"monerotrust", "mnsync", &mnsync, true, true, false},
        {"monerotrust", "spork", &spork, true, true, false},
        {"monerotrust", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzxmtseed", &getzxmtseed, false, false, true},
        {"zerocoin", "setzxmtseed", &setzxmtseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzxmt", &searchdzxmt, false, false, true},
        {"zerocoin", "dzxmtstate", &dzxmtstate, false, false, true},
...
{
    return "> monerotrust-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12141/\n";
}
