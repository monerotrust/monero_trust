...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MoneroTrust Core monerotrust-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  monerotrust-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded monerotrust transaction") + "\n" +
                               "  monerotrust-tx [options] -create [commands]   " + _("Create hex-encoded monerotrust transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded monerotrust transaction
