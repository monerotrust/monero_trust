...
/** Utility functions used by the MoneroTrust Qt UI.
 */
namespace GUIUtil
{
...
// Render MoneroTrust addresses in monospace font
...
// Parse "monerotrust:" URI into recipient object, return true on successful parsing
