                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXMTPathCustom = GetArg("-zxmtbackuppath", "");
    ...
    if(!strzXMTPathCustom.empty()) {
        ui->wallet_customzxmtbackuppath->setText(QString::fromStdString(strzXMTPathCustom));
        ui->wallet_customzxmtbackuppath_label->setVisible(true);
        ui->wallet_customzxmtbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXMTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MoneroTrust RPC console.") + "<br>" +
