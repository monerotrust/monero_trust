...
/* MoneroTrust GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MoneroTrust"
#define QAPP_ORG_DOMAIN "monerotrust.org"
#define QAPP_APP_NAME_DEFAULT "MoneroTrust-Qt"
#define QAPP_APP_NAME_TESTNET "MoneroTrust-Qt-testnet"
