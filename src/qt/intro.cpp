...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MoneroTrust Core"),
     ...
     * override -datadir in the monerotrust.conf file in the default data directory
     * (to be consistent with monerotrustd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
