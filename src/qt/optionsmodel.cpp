...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XMT);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMoneroTrustAmount"))
        SoftSetArg("-anonymizemonerotrustamount", settings.value("nAnonymizeMoneroTrustAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in monerotrust.cpp during shotdown to also remove the window positions
