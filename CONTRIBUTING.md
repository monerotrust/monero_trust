Contributing to MoneroTrust Core
============================

The MoneroTrust Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/monerotrust-project/monerotrust/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MoneroTrust Core project, and is not to be
confused with overall MoneroTrust Network Protocol consensus changes.

Whether a pull request is merged into MoneroTrust Core rests with the project merge
...
Patches that change MoneroTrust consensus rules are considerably more involved than
...
Where a patchset proposes to change the MoneroTrust consensus, it must have been
...
The project leader is the release manager for each MoneroTrust Core release.
